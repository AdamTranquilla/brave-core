...
// The widget delegate of an ad notification popup view. The view is owned by
// the widget
class AdNotificationPopup : public views::WidgetDelegateView,
 ...
 public:
  ...
  static void FadeOutAndCloseWidgetView(const std::string& notification_id);
 ...
 private:
  ...
  AdNotificationView* GetAdNotificationView() const;
