...
#ifndef BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_AD_BLOCK_SUBSCRIPTIONS_SERVICE_MANAGER_H_
#define BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_AD_BLOCK_SUBSCRIPTIONS_SERVICE_MANAGER_H_
...
class AdBlockSubscriptionServiceManager {
 public:
  explicit AdBlockSubscriptionServiceManager(BraveComponent::Delegate* delegate);
  ~AdBlockSubscriptionServiceManager();

  std::vector<FilterListSubscriptionInfo> GetSubscriptions() const;
  std::string& GetSubscriptionSource(const SubscriptionIdentifier& id);
...
#endif  // BRAVE_COMPONENTS_BRAVE_SHIELDS_BROWSER_AD_BLOCK_SUBSCRIPTIONS_SERVICE_MANAGER_H_
